            ...
            <div className="container flex flex-wrap items-center justify-between mx-auto">
              ...
              <div className="flex items-center md:justify-between lg:hidden">
                <Link to="/dashboard/upgrade-profile">
                  <div className="text-white border-slate-300 justify-center  bg-secondary focus:outline-none  font-medium rounded-full text-xs px-5 py-1.5 text-center inline-flex items-center mr-3">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 20 20"
                      fill="#fff"
