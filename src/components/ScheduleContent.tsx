      ...
      {datas.map((event, index) => (
        <div className="bg-white rounded-lg px-4 py-4 mb-4" key={index}>
          <div className="pb-6">
            ...
            <div className="pb-2 flex items-center justify-between border-b border-b-gray-300 text-sm">
              <div className="text-sm">
                ...
                <span
                  style={
                    selected === 10 && selectedEvent === "setting"
                      ? { color: textColor }
                      : {}
                  }
          ...
          <div className="pb-4">
                  ...
                  {index === showDetails && (
                    <div className="text-xs py-2">
                      <div className="block xl:hidden">
                        <span className="block mb-2">{event.email}</span>
                        <span className="block mb-2">{event.phone}</span>
            ...
            {selectedEvent === "past" &&
              (event.past.length ? (
                event.past.map((pastEvent, index) => (
                  <div key={index}>
                    <div className="grid grid-cols-3 xl:grid-cols-6 text-xs py-4 items-center">
                      <span className="opacity-80">
                        {pastEvent.from}-{pastEvent.to}
                      </span>
                      <p className="text-black text-sm font-extrabold text-start">
                        {pastEvent.name}
                      </p>
                    ...
                    {index === showPastDetails && (
                      <div className="text-xs py-2">
                        <div className="block xl:hidden">
                          <span className="block mb-2">{pastEvent.email}</span>
                          <span className="block mb-2">{pastEvent.phone}</span>
                          <div className="flex items-center py-4">
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              viewBox="0 0 24 24"
              ...
              <div>
                ...
                <div className="flex items-center">
                  ...
                  <input
                    ...
                    required
                  />
                  <p className="text-sm">per Hour/day</p>
                </div>
              </div>
            )}
          </div>
