            ...
            <div className="pb-2 flex items-center justify-between border-b border-b-gray-300 text-sm">
              ...
              <div className="flex items-center">
                <button
                  ...
                  className={`p-2 mr-2 lg:mr-5 text-xs lg:w-[100px] lg:flex items-center justify-center font-medium text-center text-white  rounded-full focus-visible:outline-none focus:outline-none ${
                ...
                >
                  <svg
                    ...
                    viewBox="0 0 24 24"
                    fill="currentColor"
                    className="w-5 h-5 mr-2 hidden lg:flex"
                  >
                    <path
                      fillRule="evenodd"
