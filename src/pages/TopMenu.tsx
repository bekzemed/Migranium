...
const TopMenu = () => {
  return (
    <div className="lg:flex bg-primary px-4 pb-20 pt-36 md:px-28 2xl:px-0">
      <div className="lg:flex 2xl:w-[1200px] m-auto">
        <div>
          ...
          <span className="font-light opacity-60 leading-relaxed pb-10 block dark:text-black">
            Don't let long wait times make you lose customers! With Migranium
            you can effectively manage your queues virtually and keep your
            customers happy.
          </span>
